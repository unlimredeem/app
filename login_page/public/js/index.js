document.addEventListener('DOMContentLoaded', () => {
    ...
    function switchTab(e) {
        ...
        codeInputs.forEach(input => input.classList.toggle('active', input.id.startsWith(targetTab)));
    }
    ...
    if (c_bg && color_picker && hero) {
        const bgInputHandler = () => {
            ...
            if (hero) hero.style.backgroundColor = newColor;
        };
        c_bg.addEventListener('click', () => {
            ...
            c_bg.onclick = () => window.location.reload();
        }, { once: true });
    }
    ...
    if (c_color && text_color_picker && reset_color) {
        c_color.addEventListener('click', () => {
            ...
            if (isColorInspecting) {
                ...
                if (selectedElement) selectedElement.classList.remove('selected-for-color-change');
        ...
        text_color_picker.addEventListener('input', () => {
            if (selectedElement) {
                ...
                reset_color.onclick = () => window.location.reload();
            }
        });
    }
    ...
    if (c_font && font_picker && reset_font) {
        c_font.addEventListener('click', () => {
            ...
            if (isFontInspecting) {
                ...
                if (selectedFontElement) selectedFontElement.classList.remove('selected-for-font-change');
        ...
        font_picker.addEventListener('input', () => {
            if (selectedFontElement) {
                ...
                reset_font.onclick = () => window.location.reload();
            }
        });
    }
    ...
    if (registerForm) {
        registerForm.addEventListener("submit", async (e) => {
            ...
            const qualification = registerForm.qualification.value;
        ...
        loginForm.addEventListener("submit", async (e) => {
            ...
            try {
                const response = await fetch("/login", {
                    ...
                    body: JSON.stringify({ email, password, us})
                });
